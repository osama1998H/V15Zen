...
website_context = {
    "favicon": "/assets/datavalue_theme_15/images/logo-icon.png",
...
email_brand_image = "assets/datavalue_theme_15/images/logo-icon.png"

# include js, css files in header of web template
web_include_css = [
    "assets/datavalue_theme_15/plugins/fontawesome/all.min.css",
    "assets/datavalue_theme_15/css/login.css",
    "assets/datavalue_theme_15/css/dv-login.css?ver=1.0"
]
web_include_js = [
